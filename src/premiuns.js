const premiuns = (prefix) => {
	return `
-ツ▲ FUNÇÕES PREMIUM ▲ツ-

❗para ter acesso premium 
mande o comando ${prefix}comprar
...
♢➤${prefix}rename (nome que quer ponhar)
✓Utilidade－renomeia a figurinha que selecionar

♢➤${prefix}ttp (texto) faz fig do texto com cores aleatórias
♢➤${prefix}attp
✓Utilidade－figurinha de texto piscando ex －attp 123
♢➤${prefix}attp1
♢➤${prefix}attp2
♢➤${prefix}attp3   (esses outros attps é pra mudar a fonte)
♢➤${prefix}attp4
♢➤${prefix}attp5
♢➤${prefix}attp6
...
♢➤${prefix}pmake (nome/nick) [+18]
✓Utilidade-faz plaquinha de um geitin

♢➤${prefix}pmake2 (nome/nick) [+18]
✓Utilidade-faz plaquinha de outro geitin`
}
exports.premiuns = premiuns